            ...
            <div class="col-md-12 p-0 product_data_2">
              <div class="product_shadow">
                <div id="video-carousel-example2" class="carousel slide carousel-fade" data-ride="carousel">
                      ...
                      <div class="carousel-item active">
                        <div class="view">
                          <video class="video-fluid videos_shadow" autoplay loop muted >
                            <source src="img/videos/science.mp4" type="video/mp4" />
                          </video>
                          <div class="mask rgba-indigo-light"></div>
                        </div>
                      </div>
                  ...
                  <div class="products_items_data_left">
                      <div class="product_text_data">
                        ...
                        <div class="product-head">
                            <h3>Doge Park</h3>
                            <p>A park dedicated to dogs worldwide including the famous Shiba Inu from Japan</p>
                        </div>
                ...
                <div id="video-carousel-example2" class="carousel slide carousel-fade" data-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                      <div class="carousel-item active">
                        <div class="view">
                          <video class="video-fluid videos_shadow" autoplay loop muted >
                            <source src="img/videos/space_videos.mp4" type="video/mp4" />
                          </video>
                          <div class="mask rgba-indigo-light"></div>
                        </div>
                      </div>
                  ...
                  <div class="products_items_data_right">
                      <div class="product_text_data">
                        ...
                        <div class="product-head">
                            ...
                            <p>A shopping venue to cater to everyone’s needs. Shiba shopping district includes shopping malls, watch stores, apparel boutiques</p>
                        </div>
                    </div>
                  </div>
              </div>
                ...
                <div id="video-carousel-example2" class="carousel slide carousel-fade" data-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                      <div class="carousel-item active">
                        <div class="view">
                          <video class="video-fluid videos_shadow" autoplay loop muted >
                            <source src="img/videos/blockchain.mp4" type="video/mp4" />
                          </video>
                          <div class="mask rgba-indigo-light"></div>
                        </div>
                      </div>
                  ...
                  <div class="products_items_data_left">
                      <div class="product_text_data ">
                        ...
                        <div class="product-head">
                            ...
                            <p>Are you an aesthete? Do you love art and artists? Opensea art and museum center has a range of art NFTs </p>
                        </div>
                    </div>
                  </div>
              </div>
...
<!-- videos section ended  -->
  ...
  <!-- OUR_ROADMAP  -->
    <section class="OUR_ROADMAP desk-roadmap" id="Roadmap">
    ...
    <!-- // -->
    <!-- OUR_ROADMAP mobile -->
    <section class="OUR_ROADMAP mobile-roadmap" id="Roadmap">
    ...
    <section class="management_team" id="Teams">
        <div class="container management_team_data" >
            <div class="heading">
                <h1 class="heading_text"><img class="heading_logo" src="img/heading_left_logo.png" alt=""> OUR TEAM <img class="heading_logo" src="img/heading_right_logo.png" alt=""></h1>
              </div>
            <div class="row">
                <div class="management_team">
                    <h4 class="oursteams_text">Management Team </h4>
                ...
                <div class="marketing_team">
                     <h4 class="oursteams_text">Marketing Team </h4>
                    ...
                    <div class="team_data_3">
                        ...
                        <div class="box team_member">
                            <img class="teams_img" src="img/team/Arshi-Usmani.jpg" alt="">
                            <h4 class="teams_text">Arshi Usmani</h4>
                            <p class="teams_para">Marketing Manager</p>
                        </div>
                        <div class="box team_member">
                            <img class="teams_img" src="img/team/Surbhi.jpg" alt="">
