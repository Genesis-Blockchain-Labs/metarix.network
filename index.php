                  ...
                  <div class="products_items_data_left">
                      <div class="product_text_data">
                        ...
                        <div class="product-head">
                            <h3>Science Exploration Center</h3>
                            <p>Perform different science experiments in labs and attend latest conferences</p>
                        </div>
                ...
                <div id="video-carousel-example2" class="carousel slide carousel-fade" data-ride="carousel">
                  ...
                  <div class="products_items_data_right">
                      <div class="product_text_data">
                        ...
                        <div class="product-head">
                            <h3>Space exploration center</h3>
                            <p>Get a real feel of being in space in AR/VR</p>
                        </div>
                    </div>
                  </div>
              </div>
                ...
                <div id="video-carousel-example2" class="carousel slide carousel-fade" data-ride="carousel">
                  ...
                  <div class="products_items_data_left">
                      <div class="product_text_data ">
                        ...
                        <div class="product-head">
                            <h3>Blockchain Valley</h3>
                            <p>Learn about blockchains and blockchain technology on white boards and display boards</p>
                        </div>
                    </div>
                  </div>
              </div>
...
<!-- videos section ended  -->
        ...
        <div class="row">
            <div class="col-md-12 card_data">
                ...
                <div class="box-container left_border">
                    ...
                    <div class="box-head">
                        <h3>Startup Valley</h3>
                        <p>Showcase your startup and do IDO directly in the metaverse</p>
                    </div>
                </div>
                <div class="box-container left_border">
                    <div class="box-img">
                ...
                <div class="box-container">
                    ...
                    <div class="box-head">
                        <h3>Arts</h3>
                        <p>we can display digital art and 3D nfts in one location and people can come and vist and check the art and buy iyt</p>
                    </div>
                </div>
            </div>
            <div class="button">
  ...
  <!-- OUR_ROADMAP  -->
    <section class="OUR_ROADMAP" id="Roadmap">
