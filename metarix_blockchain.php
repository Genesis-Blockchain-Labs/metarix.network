<?php include("includes/header.php"); ?>
 ...
 <section class="blockchain_main" id="blockchain_main" >
     <div class="container blockchain_main_data">
         <div class="row">
 ...
 <!-- blochain_main_pages ended -->

 <!-- blockchain our services stated  -->
 <section class="our_services" id="our_services">
  ...
  <!-- blockchain our services ended  -->

  <!-- bitcoin section started  -->
